  ...
  let s:guishade0 = "#171411"
  let s:guishade1 = "#382b19"
  let s:guishade2 = "#594120"
  let s:guishade3 = "#7a5828"
  let s:guishade4 = "#9c6f30"
  let s:guishade5 = "#bd8638"
  let s:guishade6 = "#de9c3f"
  let s:guishade7 = "#ffb347"
  let s:guiaccent0 = "#d2fe90"
  let s:guiaccent1 = "#c9ff66"
  let s:guiaccent2 = "#a6813f"
  let s:guiaccent3 = "#ffd06b"
  let s:guiaccent4 = "#ffb494"
  let s:guiaccent5 = "#ff401f"
  let s:guiaccent6 = "#fe5879"
  let s:guiaccent7 = "#a8fe90"
  let s:ctermshade0 = 233
  let s:ctermshade1 = 235
  let s:ctermshade2 = 95
  let s:ctermshade3 = 101
  let s:ctermshade4 = 137
  let s:ctermshade5 = 179
  let s:ctermshade6 = 6
  let s:ctermshade7 = 221
  let s:ctermaccent0 = 193
  let s:ctermaccent1 = 192
  let s:ctermaccent2 = 143
  let s:ctermaccent3 = 222
  let s:ctermaccent4 = 223
  let s:ctermaccent5 = 203
  let s:ctermaccent6 = 210
