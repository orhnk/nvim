  ...
  let s:guiaccent0 = "#fb9898"
  let s:guiaccent1 = "#f372a6"
  let s:guiaccent2 = "#cfee5d"
  let s:guiaccent3 = "#fcef5f"
  let s:guiaccent4 = "#76f36d"
  let s:guiaccent5 = "#99f35e"
  let s:guiaccent6 = "#ecde83"
  let s:guiaccent7 = "#4efd7a"
  ...
  let s:ctermaccent1 = 211
  let s:ctermaccent2 = 192
  let s:ctermaccent3 = 228
  let s:ctermaccent4 = 120
  let s:ctermaccent5 = 156
  let s:ctermaccent6 = 223
  let s:ctermaccent7 = 120
