  ...
  let s:guishade0 = "#251f18"
  let s:guishade1 = "#3e3e2b"
  let s:guishade2 = "#575e3e"
  let s:guishade3 = "#707d51"
  let s:guishade4 = "#8a9d64"
  let s:guishade5 = "#a3bc77"
  let s:guishade6 = "#bcdc8a"
  let s:guishade7 = "#d5fb9d"
  let s:guiaccent0 = "#f57656"
  let s:guiaccent1 = "#fb5656"
  let s:guiaccent2 = "#6e5dee"
  let s:guiaccent3 = "#5f79fc"
  let s:guiaccent4 = "#6df1f3"
  let s:guiaccent5 = "#5ef360"
  let s:guiaccent6 = "#eaec83"
  let s:guiaccent7 = "#ff8800"
  let s:ctermshade0 = 234
  let s:ctermshade1 = 237
  let s:ctermshade2 = 101
  let s:ctermshade3 = 242
  let s:ctermshade4 = 144
  let s:ctermshade5 = 150
  let s:ctermshade6 = 187
  let s:ctermshade7 = 193
  let s:ctermaccent0 = 210
  let s:ctermaccent1 = 210
  let s:ctermaccent2 = 105
  let s:ctermaccent3 = 105
  let s:ctermaccent4 = 123
  let s:ctermaccent5 = 120
  let s:ctermaccent6 = 229
